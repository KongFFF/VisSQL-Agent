...
def parse_args():
    ...
    parser.add_argument(
        "--superlative-mode",
        choices=["v1", "v2", "phase0", "phase1", "phase1_c", "phase1_d", "phase1_e"],
        default="v1",
        help="superlative mode: v1=original, phase0=current template + exclusion layer, v2=alias of phase0, phase1=non-trained router, phase1_c=phase1 with controlled slot filling, phase1_d=phase1 plus enumerated entity-count planner, phase1_e=phase1_d plus structured projection selection for count-family templates",
    )
    parser.add_argument(
