...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="selector3",
        help="Which selector module to use for the final candidate choice (default: selector3)",
    )
    parser.add_argument(
        "--schema-mode",
        ...
        for idx in range(start_index, end_index):
            ...
            if agent_result is None:
                ...
                summary_record = {
                    ...
                    "candidate_shortage": agent_result.get("candidate_shortage"),
                    "candidate_count": len(((agent_result.get("attempt_records") or [{}])[-1]).get("candidate_sqls", [])),
